...
//wifi
const char *ssid = "Ram-House";  //ENTER YOUR WIFI SETTINGS
const char *password = "Ram.nive16";

//phone
// const char *ssid = "AndroidAP_6586";  //ENTER YOUR WIFI SETTINGS
// const char *password = "dhananjeyan";
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  //wifi
  Link = "http://192.168.1.7:5000/api/request" + getData;
